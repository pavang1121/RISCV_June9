...
\TLV
   ...
   |cpu
      @0
         ...
         $instr_mem_rd_en = !$reset;
         $instr_mem_rd_addr[M4_IMEM_INDEX_CNT -1 : 0] = $pc[M4_IMEM_INDEX_CNT+1:2];
      
      // instruction type identification
      @1
         $instr[31:0] = $instr_mem_rd_data[31:0];
         $inc_pc[31:0] = $pc + 32'd4;
         $is_i_instr = $instr[6:2] ==? 5'b0000x || $instr[6:2] ==? 5'b001x0 || $instr[6:2] ==? 5'b11001  || $instr[6:2] ==? 5'b11100;
         $is_s_instr = $instr[6:2] == 5'b0100x;
         $is_r_instr = $instr[6:2] ==? 5'b01011 ||$instr[6:2] ==? 5'b10100 ||  $instr[6:2] ==? 5'b011x0;                       
         $is_b_instr = $instr[6:2] == 5'b11000;
         $is_u_instr = $instr[6:2] == 5'b0x101;
         $is_j_instr = $instr[6:2] == 5'b11011;

         //instruction decode, and gather bit value to load into imm register
         ...
         // based on other instruction fields
         ...
         // Base instrn set decode - rv32i base instrn set
         ...
         // input to alu: register file read to ALU
